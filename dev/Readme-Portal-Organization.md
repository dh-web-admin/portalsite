...
│   ├── Bid_tracking/                  # Bid tracking page
│   │   ├── index.php
│   │   └── style.css
│   ├── employee_information/          # Employee information page
│   │   ├── index.php
│   │   └── style.css
...
│   │   ├── index.php
│   │   └── style.css
│   ├── for_sale/                      # For sale items page
│   │   ├── index.php
│   │   └── style.css
│   ├── manuals/                       # Manuals page
│   │   ├── index.php
│   │   └── style.css
│   ├── maps/                          # Maps page
│   │   ├── index.php
...
│   │   ├── index.php
│   │   └── style.css
│   ├── project_checklist/             # Project checklist page
│   │   ├── index.php
│   │   └── style.css
...
3. login_register.php validates credentials
  ├── On success → pages/dashboard/ (all roles)
...
```
admin/dashboard/ → "User List" tile
  └── admin/user_list.php
...
```
admin/dashboard/ → "Remove User" tile
  └── admin/remove_user.php
