...
$stmt = $conn->prepare("SELECT file_url, uploaded_at FROM equipment_uploads WHERE equipment_id = ? AND field = 'air_filters' ORDER BY uploaded_at DESC");
        ...
        <div class="admin-layout">
            <main class="content-area">
                <div class="main-content">
                    <div class="card">
                        <h1 class="success" style="text-align:center;">Air Filters Files</h1>
                        ...
                        while ($row = $res->fetch_assoc()):
                            echo '<pre style="color:blue;">'; var_dump($row); echo '</pre>';
                        ...
                        ?>
                            <li>
                                <?php if ($isImage): ?>
                                    <div style="margin-bottom:8px;"><img src="<?php echo htmlspecialchars($fileUrl); ?>" alt="Air Filter Image" style="max-width:220px;max-height:160px;display:block;border-radius:8px;box-shadow:0 2px 8px #0001;"></div>
                                <?php endif; ?>
