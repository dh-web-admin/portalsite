        ...
        <div class="admin-layout">
            <main class="content-area">
                <div class="main-content">
                    <div class="card">
                        <h1 class="success" style="text-align:center;">Warranty Files</h1>
                        ...
                        ?>
                            <li>
                                <?php if ($isImage): ?>
                                    <div style="margin-bottom:8px;"><img src="<?php echo htmlspecialchars($fileUrl); ?>" alt="Warranty Image" style="max-width:220px;max-height:160px;display:block;border-radius:8px;box-shadow:0 2px 8px #0001;"></div>
                                <?php endif; ?>
