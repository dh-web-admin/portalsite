...
<head>
    ...
    <title>All Filter Change Reports</title>
    ...
    /* Card & table styles (match all_oil_change_reports) */
        ...
        <div class="admin-layout">
            ...
            <main class="content-area">
                <div class="main-content">
                    <h1 class="admin-page-title" style="text-align:center;margin-top:6px;margin-bottom:18px;font-size:26px;font-weight:800;">All Filter Change Reports</h1>
                    <div style="display:flex; gap:24px; align-items:flex-start;">
                        <div style="flex:0 0 320px; max-width:320px;">
                            <div style="margin-bottom: 16px;">
                                <a href="index.php<?php echo $previewParam; ?>" class="equipment-btn equipment-btn--secondary" style="padding: 10px 18px; border-radius: 8px; font-weight: 600; font-size: 14px; background: #f3f4f6; color: #6b7280; border: none; text-decoration: none; display: inline-block; margin: 0; transition: background 0.2s;">&larr; Back to Equipments</a>
                            </div>
...
?>
                        ...
                        <div style="flex:1 1 auto;">
                            ...
                            <div class="equipment-card">
                                <div class="equipment-card-title">Filter Change History</div>
                                <div id="historyPanel">
...
if ($selected > 0) {
    $historyStmt = $conn->prepare('SELECT id, equipment_id, filter_id, filter_name, make, part_number, change_date, equipment_hours, changed_by, created_at FROM filter_reports WHERE equipment_id = ? ORDER BY change_date DESC, id DESC');
    ...
    echo '<thead><tr><th>Report #</th><th>Filter</th><th>Make</th><th>Part Number</th><th>Change Date</th><th>Equipment Hours</th><th>Changed By</th><th>Recorded At</th></tr></thead>';
    echo '<tbody>';
    ...
    if ($historyRes && $historyRes->num_rows > 0) {
        ...
        echo '<tr><td colspan="8" style="text-align: center; padding: 24px; color: #94a3b8;">No filter change records yet. Select an equipment to view its history.</td></tr>';
    }
    ...
    (function(){
        ...
        document.querySelectorAll('.select-equipment-btn').forEach(function(b){
            b.addEventListener('click', function(){
                ...
                // preserve preview_role if present
        ...
        if (dl) dl.addEventListener('click', function(){
            ...
            a.href = url; a.download = 'filter_change_reports.csv';
        ...
        if (pr) pr.addEventListener('click', function(){
            ...
            win.document.write('<html><head><title>Print Filter Change Reports</title>');
