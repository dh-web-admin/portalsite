...
<head>
    ...
    <title>Bid Tracking</title>$result = $conn->query($query);$result = $conn->query($query);
        ...
        <div class="admin-layout">if ($user['role'] !== 'admin') {if ($user['role'] !== 'admin') {
            ...
            <main class="content-area">    header("Location: ../auth/login.php");    header("Location: ../auth/login.php");
                ...
                <div class="main-content">
                    ...
                    <h1>Bid Tracking</h1>    exit();    exit();

                    <!-- Bid Tracking content will go here -->
...
</body>    <title>Bid Tracking</title>    <title>Equipments</title>
