...
<head>
    ...
    <title>Scheduling</title>$result = $conn->query($query);$result = $conn->query($query);
...
</body>    <title>Scheduling</title>    <title>Equipments</title>
        ...
        <div class="admin-layout">        <div class="admin-layout">
            ...
            <main class="content-area">            <main class="content-area">
                ...
                <div class="main-content">                <div class="main-content">
                    ...
                    <h1>Scheduling</h1>                    <h1>Equipments</h1>

                    <!-- Scheduling content will go here -->                    <!-- Equipment content will go here -->
