...
<head>
    ...
    <title>Maps</title>$result = $conn->query($query);$result = $conn->query($query);
...
</body>    <title>Maps</title>    <title>Equipments</title>
        ...
        <div class="admin-layout">        <div class="admin-layout">
            ...
            <main class="content-area">            <main class="content-area">
                ...
                <div class="main-content">                <div class="main-content">
                    ...
                    <h1>Maps</h1>                    <h1>Equipments</h1>

                    <!-- Maps content will go here -->                    <!-- Equipment content will go here -->
