...
<head>
    ...
    <title>Pictures</title>$result = $conn->query($query);$result = $conn->query($query);
        ...
        <div class="admin-layout">if ($user['role'] !== 'admin') {if ($user['role'] !== 'admin') {
            ...
            <main class="content-area">    header("Location: ../auth/login.php");    header("Location: ../auth/login.php");
                ...
                <div class="main-content">
                    ...
                    <h1>Pictures</h1>    exit();    exit();

                    <!-- Pictures content will go here -->
...
</body>    <title>Pictures</title>    <title>Equipments</title>
        ...
        <div class="admin-layout">        <div class="admin-layout">
            ...
            <main class="content-area">            <main class="content-area">
                ...
                <div class="main-content">                <div class="main-content">
                    ...
                    <h1>Pictures</h1>                    <h1>Equipments</h1>

                    <!-- Pictures content will go here -->                    <!-- Equipment content will go here -->
