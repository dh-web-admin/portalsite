    ...
    <div class="admin-layout">
      ...
      <main class="content-area">
        ...
        <div class="main-content">$role = $user ? $user['role'] : 'laborer';
          ...
          <!-- Forms content will go here -->$stmt->close();require_once __DIR__ . '/../config/config.php';require_once __DIR__ . '/../config/config.php';
    ...
    <div class="admin-layout">
      ...
      <main class="content-area">
        ...
        <div class="main-content">if ($user['role'] !== 'admin') {if ($user['role'] !== 'admin') {
          ...
          <!-- forms content will go here -->    header("Location: ../auth/login.php");    header("Location: ../auth/login.php");
