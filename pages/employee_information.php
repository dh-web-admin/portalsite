...
require_once '../config/config.php';    header("Location: ../auth/login.php");    header("Location: ../auth/login.php");
...
<head>
    ...
    <title>Employee Information</title>$result = $conn->query($query);$result = $conn->query($query);
