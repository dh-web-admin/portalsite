...
<head>
    ...
    <title>Project Checklist</title>$result = $conn->query($query);
...
</body>    <title>Project Checklist</title>$result = $conn->query($query);$result = $conn->query($query);
